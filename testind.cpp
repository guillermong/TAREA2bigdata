...
int main(int argc, char **argv) {
	...
	*/	  	
	...
	cout<<endl<<"TIEMPO CONSTRUCCION INDCE INV=	"<<tiempo<<endl;	
	cout<<"POSTING=		"<<posting<<endl; //postings (parece)
	cout<<"CANTIDAD DE PALABRAS=	"<<indice.size()<<endl<<endl; // cantidad de palabras	
	...
	for (k=0;k<=2;k++){
		...
		for(pos=1; pos<=p ;pos++){
			...
			cout<<endl<<"lista1("<<palabra1<<")=";
			for(unsigned int i = 0; i<lista1.size(); i++) {
			cout << lista1[i] <<" ";
			}
			cout<<endl<<"lista2=("<<palabra2<<")";
